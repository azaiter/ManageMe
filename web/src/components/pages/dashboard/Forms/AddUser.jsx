              ...
              <form role="form" onSubmit={this.handleRegister.bind(this)} className="ng-pristine ng-valid"> 
                <div className="form-content"> 
                  <div className="form-group"> 
                    <input type="text" className="form-control" placeholder="First Name" placeholder="First Name" errorText={this.state.first_error_text} onChange={(e) => this.changeValue(e, 'first')}  /> 
                  </div>
                  <div className="form-group"> 
                    <input type="text" className="form-control " placeholder="Last Name" placeholder="Last Name" errorText={this.state.last_error_text} onChange={(e) => this.changeValue(e, 'last')} /> 
                  </div>
                  <div className="form-group"> 
                    <input type="text" className="form-control " placeholder="Username" placeholder="Username" errorText={this.state.user_error_text} onChange={(e) => this.changeValue(e, 'username')}  /> 
                  </div> 
                  <div className="form-group"> 
                    <input type="email" className="form-control " placeholder="Email" placeholder="Email" errorText={this.state.email_error_text} onChange={(e) => this.changeValue(e, 'email')}  /> 
                  </div> 
                  <div className="form-group"> 
                    <input type="text" className="form-control " placeholder="Phone Number" placeholder="Phone Number" errorText={this.state.phoneNum_error_text} onChange={(e) => this.changeValue(e, 'phoneNum')} /> 
                  </div>
                  <div className="form-group"> 
                    <input type="text" className="form-control " placeholder="Address" placeholder="Address" errorText={this.state.address_error_text} onChange={(e) => this.changeValue(e, 'address')} /> 
                  </div>
                  <div className="form-group"> 
                    <input type="password" className="form-control " placeholder="Password (at least 1 lower, 1 upper, 1 special character, and 1 digit)" errorText={this.state.password_error_text} onChange={(e) => this.changeValue(e, 'password')} /> 
                  </div> 
                  <div className="form-group"> 
                    <input type="password" className="form-control " placeholder="Confirm Password" errorText={this.state.passwordConfirm_error_text} onChange={(e) => this.changeValue(e, 'passwordConfirm')} /> 
                  </div> 
                </div>
                <p style={{ color: "red" }}>{this.state.registerError}</p>
                <button className="btn  btn-lg btn-rounded btn-block" onClick={(e) => this.handleRegister(e)} disabled={this.state.disabled}>Register</button>                  
              </form> 
            </div> 
          </div> 
